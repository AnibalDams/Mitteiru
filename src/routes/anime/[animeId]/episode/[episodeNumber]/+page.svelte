...
{:else}
<NotFoundError image="http://localhost:8000/static/WhatsApp Image 2025-01-16 at 9.51.21 AM.jpeg" text="This anime doesn't have the given episode. Sorry for the inconvenience :("/>
{/if}
<style>
    .episode_container {
        width: 100%;
