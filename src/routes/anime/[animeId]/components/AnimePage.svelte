    ...
    <div class="right_sec">
        ...
        <div class="anime_information">
            ...
            <div class="related_anime">
                ...
                <div class="related_anime_card" on:click={()=>goto(`/anime/${dataA.similarAnime.id}`)}>
                    <img
                ...
                {:else}
                <span style="display:inline-block; margin-top:20px;font-weight:bold;">No similar anime was found :(</span>
                {/if}
            </div>
        </div>
    </div>
