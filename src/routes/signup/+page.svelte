...
<form method="POST" class="container" action="?/signup">
    ...
    <input type="text" bind:value={username} name="username" class="input" placeholder="username" required/>
    ...
    <span style="display:inline-block; margin-top: 20px; font-weight:bold;">Do you already have an account? <a href="/login" style="color:blue;text-decoration:none;">Log in!</a></span>
